...
<div>
	<div class="container">
		...
		<h2 class="mt-4 mb-4">Udvikler-kommentarer mens vi laver hjemmesiden</h2>
		<h3>Generelle kommentarer og spørgsmål</h3>
		<ul>
			<li>Se <a href="/kontakt">her</a> for en kommentar om kontakt siden </li>
			<li>Jeg mangler billeder til "kontakt" og "priser og vilkår" -- vil gerne snakke om hvordan vi strukturerer indholdet.</li>
			<li>Jeg har lige nu ikke så meget indhold på hverken "hvad er ems" eller "hvorfor ems", er det okay?</li>
			<li>"Hvad er EMS?" og "Hvorfor EMS"-siderne ser lidt forskellige ud - hvad kan du bedst lide?</li>
